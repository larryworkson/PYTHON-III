...
def ativar_db(exec='', id='', commit=False, conteudo = 'all'):
        ...
        conexao = sqlite3.connect('C:/Users//studi/Documents/code/PYTHON-III/DATA-SCIENCE/dataenv/00-modelo-nba/data/base.db')                
...
def base():
    conn = sqlite3.connect('C:/Users//studi/Documents/code/PYTHON-III/DATA-SCIENCE/dataenv/00-modelo-nba/data/base.db')
